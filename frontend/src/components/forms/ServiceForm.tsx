...
import { defaultServiceFormValues } from '@/data/defaults/defaultServiceFormValues';
...
export default function ServiceForm({
  ...
  const onFormSubmit = async (data: z.infer<typeof serviceFormSchema>) => {
  ...
  return (
    <FormProvider {...methods}>
      <form onSubmit={handleSubmit(onFormSubmit)}>
        ...
        {Object.entries(inputConfig.service.sections).map(
          ([sectionKey, fields]) => (
            <div key={sectionKey}>
              ...
              {sectionKey === 'categorization' ? (
                <CategorySelector modelType="service" categories={categories} />
              ) : sectionKey === 'media' ? (
                <>
                  <MediaUploader
